...
$\textit{END}$ position of the longest variant described in this record.
...
$\textit{END}$ field of VCF records whose $\textit{ALT}$ field contains
a single symbolic allele.
